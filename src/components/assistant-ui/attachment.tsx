...
function AttachmentThumb() {
  ...
  return (
    <Avatar className='aui-attachment-tile-avatar h-full w-full rounded-none'>
      ...
      />
      <AvatarFallback>
        <DocumentTextIcon className='aui-attachment-tile-fallback-icon size-8 text-muted-foreground' />
      </AvatarFallback>
    </Avatar>
  );
}
  ...
  return (
    <AttachmentPrimitive.Remove asChild>
      <TooltipIconButton
        ...
        side='top'
      >
        <XMarkIcon className='aui-attachment-remove-icon size-3 dark:stroke-[2.5px]' />
      </TooltipIconButton>
